...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const storyDescription = document.querySelector('.combined-story-foundations');
    ...
    <div className="home fade-in-element">
      ...
      <section className="welcome-section">
        <div className="welcome-content">
          ...
          {/* Story text for mobile */}
          <p className="story-text-mobile">
            Because at Subh Housing, it's never just about real estate — it's about the lives we touch and the stories we help shape.
          </p>
        </div>
      </section>
