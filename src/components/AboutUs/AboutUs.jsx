  ...
  const calculateGlobePosition = () => {
    ...
    if (scrollY >= parallaxSectionStart) {
      ...
      const scrollProgress =
        (scrollY - parallaxSectionStart) / totalScrollDistance;
  ...
  const facesData = [
    {
      ...
      quote:
        "I believe good design changes lives. We're committed to creating smart, future-ready spaces that truly feel like home.",
      message:
        "Thank you for your trust. Let's shape something remarkable together.",
    ...
    },
    {
      ...
      quote:
        "Subh Housing began with a dream — to build not just homes, but trust. Every space we create is rooted in values, comfort, and long-term peace of mind.",
      message:
        "Thank you for considering us. Your journey to a better life starts here.",
    ...
    },
    {
      ...
      quote:
        "For me, it's always about people first. We build homes that listen — to your needs, your lifestyle, and your aspirations.",
    ...
    <div className="aboutus-container fade-in-element">
      ...
      <main className="main-content">
        ...
        <div className="content-right">
          <p className="description">
            We believe home is where your heart settles, and we're honored to be
            part of your story.
          </p>
        </div>
      </main>
      ...
      <section className="mission-section">
        <div className="mission-content">
          <div className="mission-text">
            <p className="mission-subtitle">
              You know when you like a place, BUT YOU
              <br /> CAN'T EXPLAIN WHY?
            </p>
            <h2 className="mission-heading">THAT'S WHAT WE DO</h2>
          </div>
        </div>
        ...
        <div className="mission-description">
          <p>
            Our mission is to create places where people feel good and want to
            stay. Our values are the constant pursuit of innovation, technical
            excellence, and passion for what we do.
          </p>
        </div>
      ...
      <section className="parallax-section">
        ...
        <div
          className="vision-main-text"
          style={{
            opacity: scrollY > window.innerHeight * 1.2 ? 1 : 0,
            transition: "opacity 0.6s ease-in",
          }}
        >
          <div className="avision">
          ...
          <div className="values-cards">
            <div className="value-card card-1">
              ...
              <p className="card-description">
                We think ahead to build beyond. Our forward-looking mindset,
                grounded in expertise and stability, helps us create real estate
                solutions with enduring value.
              </p>
            </div>
            ...
            <div className="value-card card-2">
              ...
              <p className="card-description">
                Driven by purpose and guided by ethics, our passion fuels
                innovation and empowers us to make a meaningful, lasting
            ...
            <div className="value-card card-3">
              ...
              <p className="card-description">
                Excellence lies in the details. Through refined craftsmanship
                and unwavering consistency, we deliver quality that stands the
                test of time.
              </p>
            </div>
            ...
            <div className="value-card card-4">
              ...
              <p className="card-description">
                We believe every lasting relationship begins with trust and
                grows stronger with support. At Subh Housing, we stand by our
                customers—every step, every promise.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="step-in-section">
        ...
        <div className="faces-section">
          ...
          <div className="faces-navigation">
            <button className="aboutus-nav-arrow" onClick={prevSlide}>
              &#8249;
            </button>
            <button className="aboutus-nav-arrow" onClick={nextSlide}>
              &#8250;
            </button>
          </div>
        </div>
        ...
        <div className="newsletter-content">
          <div className="newsletter-header">
            ...
            <p className="newsletter-description">
              Subscribe to the Subh Newsletter for exclusive insights, project
              updates, and valuable property tips delivered straight to your
              inbox.
            </p>
          </div>
              ...
              <div className="form-group">
                <input
                  ...
                  className={`aboutus-form-input ${
                    newsletterErrors.fullName ? "error" : ""
                  }`}
                />
